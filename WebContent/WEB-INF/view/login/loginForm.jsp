...
<body class="hold-transition login-page">
	<div class="login-box">
		...
		<div class="login-box-body">
			...
			<a href="#">I forgot my password</a><br> <a href="join.do"
				class="text-center">신규 가입</a>
			<c:if test="${errors.idOrPwNotMatch}">
			<script>alert("아이디와 암호가 일치하지 않습니다.");</script>
</c:if>
<c:if test="${joinCheck}">
<script>alert("회원가입 완료되었습니다. 다시 로그인하세요");</script>
</c:if>
